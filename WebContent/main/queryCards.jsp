...
<body>
 ...
 <div class="admin-content">
    ...
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
      <li><a  class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>用户总数<br/>23</a></li>
      <li><a  class="am-text-warning"><span class="am-icon-btn am-icon-briefcase"></span><br/>客户总数<br/>308</a></li>
      <li><a  class="am-text-danger"><span class="am-icon-btn am-icon-recycle"></span><br/>昨日访问<br/>12</a></li>
      <li><a  class="am-text-secondary"><span class="am-icon-btn am-icon-user-md"></span><br/>在线用户<br/>3</a></li>
    </ul>
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
        <table class="am-table am-table-bd am-table-striped admin-content-table">
          <thead>
          <tr>
            <th>ID</th><th>用户名</th><th>所在公司</th><th>联系方式</th><th>管理</th>
          </tr>
          </thead>
          <tbody>
        ...
        <s:url var= "url_pre" value="card/queryCard.action">
         ...
         <ul class="am-pagination am-fr admin-content-pagination">
              ...
              <li class="am-active"><s:a href="%{url_pre}">1</s:a></li>
              <li><a href="#">2</a></li>
              <li><a href="#">3</a></li>
              <li><a href="#">4</a></li>
              <li><a href="#">5</a></li>
